...
The floor console drives it hands-free from its built-in pedal board — ten
footswitches, an encoder and LED feedback on the console board v2 — see
[hardware/console/README.md](hardware/console/README.md) and
[firmware/console_board/](firmware/console_board/).

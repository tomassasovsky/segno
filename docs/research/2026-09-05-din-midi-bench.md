...
The steps below are now scripted: `hardware/bench/midi_din_test.py` runs them and
prints a pass or fail, and `hardware/bench/README.md` is the runbook for the swap.
The list is kept as the record of what the script does and why.

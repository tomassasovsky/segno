...
| `segno_platform_mid` | 2 | **BLACK** PETG/ASA, ≥40% infill | Tall CLEAR/BANK tub (walls to 73.7 — row 2 sits on the 16in aperture's front edge since #796, 37.6 mm forward of the #366 label-top position; deck raised for flush-at-rim seating #373), hollow with boss columns — standard **M3 5×5 inserts** (4 per pedestal) + the same pocket, channels, notch and perimeter relief. |

/*
 * factory.cpp — "Segno Echo" plug-in factory + module init/deinit.
 *
...
#define kSegnoEchoVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Segno Echo", "Fx|Delay", Steinberg::Vst::kDistributable, kSegnoEchoVersion,
    INLINE_UID(SEGNO_ECHO_PROCESSOR_UID_1, SEGNO_ECHO_PROCESSOR_UID_2,
               SEGNO_ECHO_PROCESSOR_UID_3, SEGNO_ECHO_PROCESSOR_UID_4),
    segno_vst3_echo::Processor::createInstance,
    INLINE_UID(SEGNO_ECHO_CONTROLLER_UID_1, SEGNO_ECHO_CONTROLLER_UID_2,
               SEGNO_ECHO_CONTROLLER_UID_3, SEGNO_ECHO_CONTROLLER_UID_4),
    segno_vst3_echo::Controller::createInstance)

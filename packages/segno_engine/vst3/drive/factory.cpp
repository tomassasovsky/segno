/*
 * factory.cpp — "Segno Drive" plug-in factory + module init/deinit.
 *
...
#define kSegnoDriveVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Segno Drive", "Fx|Distortion", Steinberg::Vst::kDistributable, kSegnoDriveVersion,
    INLINE_UID(SEGNO_DRIVE_PROCESSOR_UID_1, SEGNO_DRIVE_PROCESSOR_UID_2,
               SEGNO_DRIVE_PROCESSOR_UID_3, SEGNO_DRIVE_PROCESSOR_UID_4),
    segno_vst3_drive::Processor::createInstance,
    INLINE_UID(SEGNO_DRIVE_CONTROLLER_UID_1, SEGNO_DRIVE_CONTROLLER_UID_2,
               SEGNO_DRIVE_CONTROLLER_UID_3, SEGNO_DRIVE_CONTROLLER_UID_4),
    segno_vst3_drive::Controller::createInstance)

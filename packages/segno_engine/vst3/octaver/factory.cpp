/*
 * factory.cpp — "Segno Octaver" plug-in factory + module init/deinit.
 *
...
#define kSegnoOctaverVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Segno Octaver", "Fx|Pitch Shift", Steinberg::Vst::kDistributable,
    kSegnoOctaverVersion,
    INLINE_UID(SEGNO_OCTAVER_PROCESSOR_UID_1, SEGNO_OCTAVER_PROCESSOR_UID_2,
               SEGNO_OCTAVER_PROCESSOR_UID_3, SEGNO_OCTAVER_PROCESSOR_UID_4),
    segno_vst3_octaver::Processor::createInstance,
    INLINE_UID(SEGNO_OCTAVER_CONTROLLER_UID_1, SEGNO_OCTAVER_CONTROLLER_UID_2,
               SEGNO_OCTAVER_CONTROLLER_UID_3, SEGNO_OCTAVER_CONTROLLER_UID_4),
    segno_vst3_octaver::Controller::createInstance)

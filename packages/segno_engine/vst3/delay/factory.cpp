/*
 * factory.cpp — "Segno Delay" plug-in factory + module init/deinit.
 *
...
#define kSegnoDelayVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Segno Delay", "Fx|Delay", Steinberg::Vst::kDistributable, kSegnoDelayVersion,
    INLINE_UID(SEGNO_DELAY_PROCESSOR_UID_1, SEGNO_DELAY_PROCESSOR_UID_2,
               SEGNO_DELAY_PROCESSOR_UID_3, SEGNO_DELAY_PROCESSOR_UID_4),
    segno_vst3_delay::Processor::createInstance,
    INLINE_UID(SEGNO_DELAY_CONTROLLER_UID_1, SEGNO_DELAY_CONTROLLER_UID_2,
               SEGNO_DELAY_CONTROLLER_UID_3, SEGNO_DELAY_CONTROLLER_UID_4),
    segno_vst3_delay::Controller::createInstance)

...
/// Pico 2); `NoopPedalLink` stands in where there is no board, and a fake
/// drives tests. Framing is `PedalLinkCodec`'s and lives below this seam, so
/// a `PedalRepository` never sees bytes.

...
explicitVersionGoldenFrames() {
  ...
  // ten times, or that indexed the array backwards. The first is the default
  // ([PedalColor.white]), which pins that the default is a colour like any
  // other on the wire rather than an absence.
  final coloredPedals = customMode.copyWith(
    pedalColors: const [
      ...
      PedalColor(0xFF, 0xFF, 0xFF), // and full white, which is not the default
    ],
  );

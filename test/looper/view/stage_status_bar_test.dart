...
void main() {
  group(StageStatusBar, () {
    ...
    group('session block', () {
      ...
      testWidgets('tapping the block opens the Sessions dialog', (
        tester,
      ) async {
    ...
    group('mode pill', () {
      ...
      testWidgets('the pill fills follow the high-contrast flavor', (
        ...
        expect(fx.$2!.a, 1.0, reason: 'fxSurface is flat by design');
      });
    });

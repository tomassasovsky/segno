        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return Row(
              children: [
                SizedBox(
                  // The pen's 360 info block; narrower desktop windows
                  // give it a third of the row instead.
                  width: infoWidth,
                  child: FittedBox(
                                        ...
                                        children: [
                                          ...
                                          if (track.effects.isNotEmpty)
                                            AppText(
                                              l10n.stageFxMarker,
                                              key: Key(
                                                'wave_fx_${track.channel}',
                                              ),
                                              style: TextStyle(
                                                fontFamily:
                                                    SurfaceTheme.displayFont,

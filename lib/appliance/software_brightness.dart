...
/// Where the brightness starts, and what a double tap on the slider puts it
/// back to. Matches `DisplayBrightnessCubit`'s own initial state — one number,
/// so "default" cannot come to mean two things.
